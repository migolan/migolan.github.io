...
<p style="display: flex; justify-content: space-between; align-items: center;">
  ...
  <span>
    <script>
        ...
        document.write('<img src="icons/email.png" width="30"' + user + '@' + domain + '" style="width: 50px; height: 50px; border: none;">');
        document.write('</a>');
    </script>
...
<a href="/projects/DeepMind Reinforcement Learning Course/DeepMind Reinforcement Learning Course.md"><b>DeepMind Reinforcement Learning Course Mindmaps</b></a><br> Mindmap cheetsheets for DeepMind's <br> Reinforcement Learning Course with David Silver
</td>
</tr>
